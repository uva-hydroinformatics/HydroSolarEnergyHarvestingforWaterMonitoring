...
# Reads USGS text file 'data_files/ILState03612600.csv', converts it into a pandas dataframe with timezone aware timestamps and saves the data in 'data_files/ILState03612600_UTC.pkl' file
